...
const int16_t XE = 204;  // pos  extra 4x4
...
{16,Y0b,wf, '1',9, 55,K_F13},{89,0,wf,'2',9, 86,K_F14},{160,0,wf,'3',9, 79,K_F15},
...
{ 0,Y2,14,kH, '`',3, 54,K_TILDE}, //~
{-14,0,wh, '1',1, 36,K_1},{X, 0,wh, '2',1, 37,K_2},{X,0,wh, '3',1, 38,K_3},{X,0,wh, '4',1, 52,K_4},
...
{ 0,Y3,22,kH, 29 ,6, 18,K_TAB}, //Tab
{-22,0,wh, 'Q',0,126,K_Q},{X, 0,wh, 'W',0,127,K_W},{X,0,wh, 'E',0,128,K_E},{X,0,wh, 'R',0,142,K_R},
...
{ 0,Y4,28,kH,  2 ,6, 19,K_Layer1}, //Caps
{-28,0,wh, 'A',0,  0,K_A},{X, 0,wh, 'S',0,  1,K_S},{X,0,wh, 'D',0,  2,K_D},{X,0,wh, 'F',0, 16,K_F},
...
{ 0,Y5,34,kH, 's',4, 28,K_LSHIFT}, //L Sh
{-34,0,wh, 'Z',0,108,K_Z},{X, 0,wh, 'X',0,109,K_X},{X,0,wh, 'C',0,110,K_C},{X,0,wh, 'V',0,124,K_V},
...
// modif:  L Ctrl, L Gui, L Alt, space, R Alt, App,K_Ss, R Gui, R Ctrl
{ 0,Y6,20,kH, 'c',4, 62,K_LCTRL},{-20,0,14,kH,  9,4, 29,K_LGUI},{-14,0,14,kH,  '\\',4, 73,K_F22},
...
const uint8_t gGui=9, gMslow=28, gLoad=31,gSave=44,gDiv=113, gEsc=72,gAdd=129,gEnt=115/*40*/,gEnt2=3,
	...
	gCtrl=62,gSh=28,gMul=112,gSub=94, gIns=77,gDel=23, gBckSp=25,gSpc=89, gC=110,gV=124,gX=109,
